...
export const GET = withPermission(PermissionConfigs.department.read)(
...
export const PUT = withPermission(PermissionConfigs.department.update)(
...
export const DELETE = withPermission(PermissionConfigs.department.delete)(
  async (_request: NextRequest, { params }: { params: { id: string } }) => {
    try {
      const { id } = params;
      const departmentId = parseInt(id);

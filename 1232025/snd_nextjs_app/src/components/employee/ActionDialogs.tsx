      ...
      <Dialog open={advanceDialogOpen} onOpenChange={setAdvanceDialogOpen}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>Request an advance payment</DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
      ...
      <Dialog open={timesheetDialogOpen} onOpenChange={setTimesheetDialogOpen}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>Submit your timesheet entry</DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setTimesheetForm({ ...timesheetForm, hours_worked: e.target.value })
                  }
                />
              </div>
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setTimesheetForm({ ...timesheetForm, overtime_hours: e.target.value })
                  }
                />
              </div>
            </div>

  ...
  const fetchPayroll = async () => {
    try {
      ...
      if (response.ok && data.success) {
        ...
        const errorMessage = data.error || data.message || 'Failed to fetch payroll details';
        toast.error(errorMessage);
        // Don't set payroll to null here - let it stay null so the "Not Found" UI shows
      }
    } catch (error) {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href={`/${locale}/payroll-management/${payroll.id}/edit`}>
                <Button
                  size="sm"

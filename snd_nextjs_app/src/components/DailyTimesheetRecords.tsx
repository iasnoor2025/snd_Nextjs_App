          ...
          <Card>
            ...
            <CardContent>
              <p className="text-xl font-bold text-foreground">
                {calculateMonthlySummary(timesheets).totalRegularHours.toFixed(1)}
              </p>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <p className="text-xl font-bold text-foreground">
                {calculateMonthlySummary(timesheets).totalOvertimeHours.toFixed(1)}
              </p>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <p className="text-xl font-bold text-foreground">
                {calculateMonthlySummary(timesheets).daysWorked}
              </p>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <p className="text-xl font-bold text-foreground">
                {calculateMonthlySummary(timesheets).daysAbsent}
              </p>
            </CardContent>
          </Card>
        </div>
                  ...
                  {Array.from(
                    ...
                    (_, i) => {
                      ...
                      return (
                        <TableCell
                          key={`day-${dateString}`}
                          className={`p-1 text-center ${isFridayDay ? 'bg-blue-600' : ''}`}
                        >
                          <div
                            className={`text-[10px] ${
                              isFridayDay ? 'font-bold text-blue-50' : 'text-muted-foreground'
                            }`}
                          >
                          ...
                          {record && record.regularHours > 0 ? (
                            <div
                              className={`text-[10px] font-medium ${
                                isFridayDay ? 'text-blue-50' : 'text-foreground'
                              }`}
                            >
                            ...
                            <div
                              className={`text-[10px] ${
                                isFridayDay ? 'text-blue-200' : 'text-muted-foreground'
                              }`}
                            >
                              -
                            </div>
                      ...
                      return (
                        ...
                        >
                          {record && record.overtimeHours > 0 ? (
                            <div
                              className={`text-[10px] font-medium ${
                                isFridayDay ? 'text-blue-50' : 'text-amber-600'
                              }`}
                            >

...
export async function GET(request: NextRequest) {
  try {
    ...
    const html = generateReportHTML(data, month, customerId, hasTimesheet, customerName, visibleColumns);
...
function generateReportHTML(data: any, month: string | null, customerId: string | null, hasTimesheet: string | null, customerName?: string | null, visibleColumns?: Record<string, boolean>): string {

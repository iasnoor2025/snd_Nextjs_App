  ...
  try {
    ...
    switch (testType) {
      case 'basic':
        ...
        try {
          const accountsEndpoint = '/api/resource/Account?limit_page_length=5&fields=["name","account_name","account_type","root_type"]';
      ...
      case 'invoices':
        // Test invoice data
        try {
          const salesEndpoint = '/api/resource/Sales Invoice?limit_page_length=5&fields=["name","grand_total","posting_date","status"]';
          ...
          const purchaseEndpoint = '/api/resource/Purchase Invoice?limit_page_length=5&fields=["name","grand_total","posting_date","status"]';

        ...
        try {
          ...
          await db
            ...
            .set({
              ...
              creditLimitUsed: newData.credit_limit_used ? parseFloat(newData.credit_limit_used) : null,
              creditLimitRemaining: newData.credit_limit_remaining ? parseFloat(newData.credit_limit_remaining) : null,
              paymentTerms: newData.payment_terms || (newData.payment_terms_days ? `${newData.payment_terms_days} days` : null),
              currentDue: newData.current_due ? parseFloat(newData.current_due) : null,
              totalValue: newData.total_value ? parseFloat(newData.total_value) : null,
              outstandingAmount: newData.outstanding_amount ? parseFloat(newData.outstanding_amount) : null,

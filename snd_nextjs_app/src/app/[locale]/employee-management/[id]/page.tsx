...
export default function EmployeeShowPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status?.toLowerCase()) {
      ...
      case 'on_leave':
        return <Badge className="bg-yellow-100 text-yellow-800">{t('employee.status.on_leave')}</Badge>;
      case 'terminated':
    ...
    return (
      <div className="flex h-screen items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <Button onClick={() => router.push(`/${locale}/employee-management`)}>
                                  ...
                                  {hasPermission('read', 'AdvancePayment') && (
                                    <Button
                                      ...
                                      onClick={() => {
                                        ...
                                        window.open(
                                          `/${locale}/employee-management/${employeeId}/advances/${advance.id}/receipt`,
                                          '_blank'
                                        );
                                      }}
                                    >
                        ...
                        <tr key={payment.id || i} className="hover:bg-muted/20 transition-colors">
                          ...
                          <td className="px-6 py-4 text-right flex gap-2 justify-end">
                            <Button
                              ...
                              onClick={() =>
                                window.open(
                                  `/${locale}/employee-management/${employeeId}/payments/${payment.id}/receipt`,
                                  '_blank'
                                )
                              }
                            >

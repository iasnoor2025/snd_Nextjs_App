             ...
             <p className="mt-2 text-gray-600">
              ...
              <div className="mt-6 flex items-center space-x-6">
                <div className="relative">
                 ...
                 <button
                   type="button"
                   className="absolute -bottom-2 -right-2 h-8 w-8 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 transition-colors shadow-lg"
                   title="Upload Photo"
                   onClick={() => {

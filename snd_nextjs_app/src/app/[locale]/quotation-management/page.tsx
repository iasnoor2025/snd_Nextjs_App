                    ...
                    <TableRow key={quotation.id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex items-center justify-end space-x-2">
                          <Link href={`/${locale}/quotation-management/${quotation.id}`}>
                            <Button variant="ghost" size="sm">
                              <Eye className="h-4 w-4" />
                            </Button>
                          </Link>
                          {hasPermission('update', 'Quotation') && (
                          ...
                          <Link href={`/${locale}/quotation-management/${quotation.id}/print`}>
                            <Button variant="ghost" size="sm">
                              <Printer className="h-4 w-4" />
                            </Button>
                          </Link>
                          <Link href={`/${locale}/quotation-management/${quotation.id}/pdf`}>
                            <Button variant="ghost" size="sm">
                              <Download className="h-4 w-4" />
                            </Button>
                          </Link>
                          {hasPermission('delete', 'Quotation') && (
                            <Button
                              variant="ghost"
                              size="sm"

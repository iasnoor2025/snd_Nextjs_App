      ...
      <div className="container mx-auto py-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm sm:text-base text-muted-foreground">{t('equipment.manage_equipment_inventory')}</p>
          </div>
                            ...
                            <TableCell>
                              <div className="flex items-center space-x-2">
                                <Button
                                  ...
                                  size="sm"
                                  onClick={() =>
                                    router.push(`/${locale}/equipment-management/${item.id}`)
                                  }
                                >
                                ...
                                {hasPermission('update', 'Equipment') && (
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      router.push(`/${locale}/equipment-management/${item.id}/edit`)
                                    }
                                  >
                                ...
                                {hasPermission('update', 'Equipment') && (
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      router.push(`/${locale}/equipment-management/${item.id}/assign`)
                                    }

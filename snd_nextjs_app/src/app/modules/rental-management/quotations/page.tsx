    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex space-x-2">
          ...
          <Link href="/modules/rental-management/quotations/create">
            <Button>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                          <Link href={`/modules/rental-management/quotations/${quotation.id}`}>
                            <Eye className="h-4 w-4 mr-2" />
                            View Details
                          </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                          <Link href={`/modules/rental-management/quotations/${quotation.id}/edit`}>
            ...
            <div className="mt-4">
              <Pagination>
                <PaginationContent>
                  ...
                  {Array.from({ length: Math.min(5, quotations.last_page) }, (_, i) => {
                    const page = i + 1;
                    return (
                  ...
                  <PaginationItem>
                    <PaginationNext
                      ...
                      className={currentPage === quotations.last_page ? 'pointer-events-none opacity-50' : 'cursor-pointer'}
                    />
                  </PaginationItem>
                </PaginationContent>
              </Pagination>

...
function CreateTimesheetContent() {
  ...
  const redirectToAssignmentPage = () => {
    ...
    if (type === 'project' && newAssignmentData.projectId) {
      router.push(`/modules/project-management/projects/${newAssignmentData.projectId}/resources`);
    } else if (type === 'rental' && newAssignmentData.rentalId) {
      router.push(`/modules/rental-management/rentals/${newAssignmentData.rentalId}`);
    } else {
      router.push(`/modules/employee-management/employees/${employeeId}/assignments/create`);
    }
  };
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <Button variant="outline" onClick={() => router.push('/modules/timesheet-management')}>

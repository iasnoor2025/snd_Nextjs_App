...
export default function AnalyticsPage() {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          setReports({
            ...
            total,
            next_page_url:
              currentPage < lastPage ? `/analytics-reports?page=${currentPage + 1}` : null,
  ...
  const handleGenerate = (id: string) => {
    ...
    setTimeout(() => {
      ...
      const updatedData = mockAnalyticsReports.map(report =>
        report.id === id ? { ...report, last_generated: new Date().toISOString() } : report
      );
  ...
  const getScheduleBadge = (schedule: string) => {
    ...
    return (
      <Badge
        className={
          scheduleColors[schedule as keyof typeof scheduleColors] || 'bg-gray-100 text-gray-800'
        }
      >
        {schedule}
      </Badge>
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      setCurrentPage(Math.min(reports.last_page, reports.current_page + 1))
                    }
        ...
        <PermissionBased action="manage" subject="Report">
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t('advanced_analytics_management_features')}</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex gap-2">
                <PermissionContent action="manage" subject="Report">

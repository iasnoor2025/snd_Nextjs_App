...
import { CalendarIcon, Download, BarChart3, TrendingUp, Users, DollarSign, FileText, PieChart, Activity } from "lucide-react";
      ...
      {reportData && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">${reportData.average_salary.toLocaleString()}</div>
              <p className="text-xs text-muted-foreground">
                +5.2% from last month
              </p>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">${reportData.total_overtime.toLocaleString()}</div>
              <p className="text-xs text-muted-foreground">

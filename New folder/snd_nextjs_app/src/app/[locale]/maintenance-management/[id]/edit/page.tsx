  ...
  const fetchMaintenanceDetails = async () => {
    try {
      ...
      if (response.success) {
        ...
        router.push(`/${locale}/maintenance-management`);
      }
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        router.push(`/${locale}/maintenance-management/${maintenanceId}`);
      } else {
    ...
    return (
      <div className="container mx-auto py-8">
        <div className="text-center">
          ...
          <Button onClick={() => router.push(`/${locale}/maintenance-management`)}>
    ...
    <div className="container mx-auto py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-4">
          <Button
            variant="outline"
            onClick={() => router.push(`/${locale}/maintenance-management/${maintenanceId}`)}
          >
            <ArrowLeft className="h-4 w-4 mr-2" />

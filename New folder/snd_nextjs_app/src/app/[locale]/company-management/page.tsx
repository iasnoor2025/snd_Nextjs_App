        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-muted-foreground">{t('company.description')}</p>
            </div>
          </div>
          <PermissionContent action="create" subject="Company">
            <Link href={`/${locale}/company-management/create`}>
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-2">
                            <PermissionContent action="read" subject="Company">
                              <Link href={`/${locale}/company-management/${company.id}`}>
                            ...
                            <PermissionContent action="update" subject="Company">
                              <Link href={`/${locale}/company-management/${company.id}/edit`}>
                                <Button variant="ghost" size="sm">
